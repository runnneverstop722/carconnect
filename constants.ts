...
import { Dealership, CarTypeInfo } from './types';

export const MOCK_DEALERSHIPS: Dealership[] = [
  { 
    id: '1', 
    name: 'Prestige Motors Toyota', 
    email: 'sales@prestigemotors.example.com', 
    location: 'New York, NY', 
    address: '100 Lexington Ave, New York, NY 10016',
    brandAffiliations: ['Toyota', 'Lexus'] 
  },
  { 
    id: '2', 
    name: 'Coastal Ford & Honda', 
    email: 'info@coastalcars.example.com', 
    location: 'Los Angeles, CA',
    address: '2020 Ocean Blvd, Santa Monica, CA 90401',
    brandAffiliations: ['Ford', 'Honda'] 
  },
  { 
    id: '3', 
    name: 'Heartland Chevrolet & GM', 
    email: 'contact@heartlandauto.example.com', 
    location: 'Chicago, IL',
    address: '300 Michigan Ave, Chicago, IL 0601',
    brandAffiliations: ['Chevrolet', 'GMC', 'Buick', 'Cadillac'] 
  },
  { 
    id: '4', 
    name: 'Summit Subaru & Mazda', 
    email: 'support@summitdrives.example.com', 
    location: 'Denver, CO',
    address: '4000 Colorado Blvd, Denver, CO 80216',
    brandAffiliations: ['Subaru', 'Mazda'] 
  },
  {
    id: '5',
    name: 'Global Auto BMW',
    email: 'bmw@globalauto.example.com',
    location: 'Miami, FL',
    address: '500 Biscayne Blvd, Miami, FL 33132',
    brandAffiliations: ['BMW']
  },
  {
    id: '6',
    name: 'Metro Honda Central',
    email: 'honda@metrohonda.example.com',
    location: 'Austin, TX',
    address: '600 Congress Ave, Austin, TX 78701',
    brandAffiliations: ['Honda']
  }
];
